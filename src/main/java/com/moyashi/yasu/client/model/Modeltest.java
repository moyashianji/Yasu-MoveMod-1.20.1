...
public class Modeltest<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(40, 8).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 8).addBox(-3.0F, 0.25F, 2.0F, 6.0F, 6.75F, 3.1F, new CubeDeformation(0.0F)).texOffs(50, 50)
